...
namespace pathtracer
{
	...
	///////////////////////////////////////////////////////////////////////////
	vec3 CustomDefined::refraction_brdf(const vec3 & wi, const vec3 & wo, const vec3 & n) {
	...
	vec3 CustomDefined::reflection_brdf(const vec3 & wi, const vec3 & wo, const vec3 & n) {
		vec3 wh = normalize(wi + wo);
	...
	vec3 CustomDefined::f(const vec3 & wi, const vec3 & wo, const vec3 & n) {
		return reflection_brdf(wi, wo, n) + refraction_brdf(wi, wo, n); 
	}

	vec3 CustomDefined::sample_wi(vec3 & wi, const vec3 & wo, const vec3 & n, float & p) {
	...
	///////////////////////////////////////////////////////////////////////////
	vec3 CustomDefinedMetal::refraction_brdf(const vec3 & wi, const vec3 & wo, const vec3 & n) { 
		return vec3(0.0f); 
	}
	...
	vec3 CustomDefinedMetal::reflection_brdf(const vec3 & wi, const vec3 & wo, const vec3 & n) { 
		//Koppar
